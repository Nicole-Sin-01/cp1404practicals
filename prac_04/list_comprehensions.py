...
last_names_above_eleven = [name.split()[1] for name in full_names if len(name) > 11]
last_names_above_eleven_string = ", ".join(last_names_above_eleven)
print(last_names_above_eleven_string)
